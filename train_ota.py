...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for k, v in model.named_modules():
        ...
        if isinstance(v, nn.BatchNorm2d) or isinstance(v, nn.GroupNorm):
            g0.append(v.weight)  # no decay for norm layers
        elif hasattr(v, 'weight') and isinstance(v.weight, nn.Parameter):
            g1.append(v.weight)  # apply decay
        if hasattr(v, 'im'):
            if hasattr(v.im, 'implicit'):           
                g0.append(v.im.implicit)
            else:
                for iv in v.im:
                    g0.append(iv.implicit)
        if hasattr(v, 'imc'):
            if hasattr(v.imc, 'implicit'):           
                g0.append(v.imc.implicit)
            else:
                for iv in v.imc:
                    g0.append(iv.implicit)
        if hasattr(v, 'imb'):
            if hasattr(v.imb, 'implicit'):           
                g0.append(v.imb.implicit)
            else:
                for iv in v.imb:
                    g0.append(iv.implicit)
        if hasattr(v, 'imo'):
            if hasattr(v.imo, 'implicit'):           
                g0.append(v.imo.implicit)
            else:
                for iv in v.imo:
                    g0.append(iv.implicit)
        if hasattr(v, 'ia'):
            if hasattr(v.ia, 'implicit'):           
                g0.append(v.ia.implicit)
            else:
                for iv in v.ia:
                    g0.append(iv.implicit)
        if hasattr(v, 'attn'):
            if hasattr(v.attn, 'logit_scale'):   
                g0.append(v.attn.logit_scale)
            if hasattr(v.attn, 'q_bias'):   
                g0.append(v.attn.q_bias)
            if hasattr(v.attn, 'v_bias'):  
                g0.append(v.attn.v_bias)
            if hasattr(v.attn, 'relative_position_bias_table'):  
                g0.append(v.attn.relative_position_bias_table)
        if hasattr(v, 'rbr_dense'):
            if hasattr(v.rbr_dense, 'weight_rbr_origin'):  
                g0.append(v.rbr_dense.weight_rbr_origin)
            if hasattr(v.rbr_dense, 'weight_rbr_avg_conv'): 
                g0.append(v.rbr_dense.weight_rbr_avg_conv)
            if hasattr(v.rbr_dense, 'weight_rbr_pfir_conv'):  
                g0.append(v.rbr_dense.weight_rbr_pfir_conv)
            if hasattr(v.rbr_dense, 'weight_rbr_1x1_kxk_idconv1'): 
                g0.append(v.rbr_dense.weight_rbr_1x1_kxk_idconv1)
            if hasattr(v.rbr_dense, 'weight_rbr_1x1_kxk_conv2'):   
                g0.append(v.rbr_dense.weight_rbr_1x1_kxk_conv2)
            if hasattr(v.rbr_dense, 'weight_rbr_gconv_dw'):   
                g0.append(v.rbr_dense.weight_rbr_gconv_dw)
            if hasattr(v.rbr_dense, 'weight_rbr_gconv_pw'):   
                g0.append(v.rbr_dense.weight_rbr_gconv_pw)
            if hasattr(v.rbr_dense, 'vector'):   
                g0.append(v.rbr_dense.vector)
        g0_len, g1_len = len(g0), len(g1)
